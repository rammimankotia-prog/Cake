  ...
  return (
    <main className="min-h-screen bg-cream">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-serif text-navy leading-tight">
            ...
            <div className="grid grid-cols-2 gap-8 pt-4">
              <div>
                <h4 className="text-3xl font-serif text-navy">1 AM</h4>
                <p className="text-sm text-navy/40 uppercase tracking-wider font-bold">Late Night Service</p>
              </div>
              <div>
                <h4 className="text-3xl font-serif text-navy">100%</h4>
                <p className="text-sm text-navy/40 uppercase tracking-wider font-bold">Artisanal & Fresh</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="glass p-10 rounded-3xl text-center border-white/5">
              ...
              <h4 className="text-xl font-serif mb-4">Global Training</h4>
              <p className="text-white/60 text-sm">Techniques refined in Russia, bringing international pastry standards to your doorstep.</p>
            </div>
            <div className="glass p-10 rounded-3xl text-center border-white/5">
              <div className="text-4xl mb-6">🎨</div>
              <h4 className="text-xl font-serif mb-4">Artisanal Craft</h4>
              <p className="text-white/60 text-sm">We don't mass-produce. Each cake is handcrafted with obsessive attention to detail.</p>
            </div>
            <div className="glass p-10 rounded-3xl text-center border-white/5">
              <div className="text-4xl mb-6">☕</div>
              <h4 className="text-xl font-serif mb-4">The Cafe Vibe</h4>
              <p className="text-white/60 text-sm">A boutique space designed for community, conversations, and the perfect iced latte.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 text-center">
        <h2 className="text-4xl font-serif text-navy mb-8">Ready to experience the magic?</h2>
